...
if __name__ == '__main__':
    ...
    datasets_path = "model_doctor-main/datasets/fashion-mnist/raw"
    ...
    save_train_dir = "model_doctor-main/datasets/fashion-mnist" + '/train'
    save_test_dir = "model_doctor-main/datasets/fashion-mnist" + '/test'

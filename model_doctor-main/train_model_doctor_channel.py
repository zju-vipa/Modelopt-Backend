...
def main():
    ...
    doctor_channel_dict = {'best_acc':best_acc,'best_epoch':best_epoch,'time consume':time.time() - since}
    
    with open(args.log_dir+'/doctor_channel_dict.json', 'w') as f:
        json.dump(doctor_channel_dict, f)

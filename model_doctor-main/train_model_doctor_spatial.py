...
def main():
    ...
    doctor_spatial_dict = {'best_acc':best_acc,'best_epoch':best_epoch,'time consume':time.time() - since}
    
    with open(args.log_dir+'/doctor_spatial_dict.json', 'w') as f:
        json.dump(doctor_spatial_dict, f)
